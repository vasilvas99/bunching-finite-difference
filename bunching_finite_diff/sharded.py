...
os.environ["XLA_FLAGS"] = "--xla_force_host_platform_device_count=64 --xla_gpu_first_collective_call_warn_stuck_timeout_seconds=60"
import jax
...
@partial(jax.jit, static_argnames=["f", "K", "M", "r", "c", "dt"], out_shardings=P("X", "Y"))
